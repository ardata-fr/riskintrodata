...
The package provides a function named `validate_dataset()` to validate 
...
- Epi units, use `validate_dataset(..., table_name = "epi_units")`.
- Emission risks, use `validate_dataset(..., table_name = "emission_risk_factors")`.
- Animal mobility, use `validate_dataset(..., table_name = "animal_mobility")`.
- Entry points, use `validate_dataset(..., table_name = "entry_points")`.
...
`validate_dataset()` to standardize and validate your dataset for use in the 
